...
1. You can knit your reports in either pdf or Word formats. If you are going to use Word you will noy be able to use the **stargazer** package for regression output. You may try to use a combination of the packages **memisc** and **pander** to achieve the same result (see https://stackoverflow.com/questions/24342162/regression-tables-in-markdown-format-for-flexible-use-in-r-markdown-v2), but I haven't tried this and I cannot guarantee that it will work. Also see https://rmarkdown.rstudio.com/articles_docx.html
...
2. If you knit as pdf with LaTeX **stargazer** will work just fine, but you need to set the *results* argument to 'asis' and run the stargazer in a separate R chunk. The code will look something like

<pre><code>```{r results = 'asis'}
stargazer(m1, m2, m3, m4, type = "latex")
```</pre></code>

3. You need to include all your code in your report. You do not need to include messages and warnings. You may also want to use cache to speed up the rendering of your document. To achieve this result include in the beginning of your R Mardown file an R chunk setting the following global options.
...
d) You can use Zotero with Word to reference and automatically create bibliographies. This is not relevent for your reports for this module, but for other modules and for your dissertation this is a very useful skill. To learn how to do this see https://www.zotero.org/support/word_processor_integration
...
g) To include a bibliography add the following line in the YAML header of your R Markdown document:

bibliography: your_bibfile_name.bib

h) The file *example.Rmd* available in the Github repo shows the minimal example of referencing and creating a bibliography with ome source (see https://raw.githubusercontent.com/abessudnov/dataanalysis3/master/example.Rmd). The associated bib file is available here: https://raw.githubusercontent.com/abessudnov/dataanalysis3/master/example.bib.

i) The bib file can be opened and edited in any text editor and you can also use software to do this, such as JabRef (http://www.jabref.org).
